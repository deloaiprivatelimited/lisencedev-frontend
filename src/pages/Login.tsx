        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            <Card className="w-full max-w-md glass border-white/10 relative overflow-hidden">
                ...
                <CardContent className="grid gap-4 relative z-10">
                        ...
                        <div className="flex items-center">
                            ...
                            <Dialog>
                                <DialogTrigger asChild>
                                    <button className="ml-auto inline-block text-sm text-primary hover:text-primary/80 hover:underline transition-colors focus:outline-none">
                                        Forgot password?
                                    </button>
                                </DialogTrigger>
                                <DialogContent className="glass-panel border-white/10 sm:max-w-[425px]">
                                    ...
                                    <div className="grid gap-4 py-4 mt-2">
                                        ...
                                        <Button type="button" className="w-full bg-primary hover:bg-primary/90 text-white font-medium transition-all rounded shadow-none">
                                            Send reset link
                                        </Button>
                                    </div>
                                </DialogContent>
                    ...
                    <Button className="w-full bg-primary hover:bg-primary/90 text-white font-medium transition-all mt-2 rounded">
                        Log in
                    </Button>
                ...
                <CardFooter className="relative z-10 w-full flex justify-center">
                    <div className="text-sm text-white/60 pt-2 w-full text-center">
